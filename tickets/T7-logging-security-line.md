...
from [does PoC data feed the audit](T8-poc-data-into-audit.md) (closed): we keep a copy of pilot spend rows in our own s3 from day one - so the designlilbro story covers retention, not just transit. payloads/prompts remain this ticket's call.
